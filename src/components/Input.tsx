  ...
  return (
    <div className="flex flex-col gap-1.5 w-full">
      ...
      <div className="relative">
        <input
          id={inputId}
          className={`w-full px-3.5 py-2.5 ${isPassword ? 'pr-10' : ''} bg-white border rounded-md text-sm text-slate-800 outline-hidden transition-all duration-200 placeholder:text-slate-400
            ${error
